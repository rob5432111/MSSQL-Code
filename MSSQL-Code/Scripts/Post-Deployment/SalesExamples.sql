...
, ('20210302 14:00', @CustomerId, @SalerId, 'Active');

------------------------------------------May Sales-------------------------------------------
INSERT INTO [External].Sale (SaleDate, CustomerId, AppUserId, SaleStatus) 
VALUES ('20210401 14:00', @CustomerId, @SalerId, 'Active')
, ('20210402 14:00', @CustomerId, @SalerId, 'Active');
...
, ('20210106 16:00', @CustomerId, @SalerId, 'Active');


----------------------------------------February Sales-----------------------------------------
INSERT INTO [External].Sale (SaleDate, CustomerId, AppUserId, SaleStatus) 
VALUES ('20210204 14:00', @CustomerId, @SalerId, 'Active')
, ('20210207 14:00', @CustomerId, @SalerId, 'Active');


----------------------------------------April Sales-------------------------------------------
INSERT INTO [External].Sale (SaleDate, CustomerId, AppUserId, SaleStatus) 
VALUES ('20210313 23:59:59.001', @CustomerId, @SalerId, 'Active')
, ('20210320 14:00', @CustomerId, @SalerId, 'Active');


------------------------------------------May Sales-------------------------------------------
INSERT INTO [External].Sale (SaleDate, CustomerId, AppUserId, SaleStatus) 
VALUES ('20210415 14:00', @CustomerId, @SalerId, 'Active')
, ('20210430 23:59', @CustomerId, @SalerId, 'Active');
...
, ('20210111 16:00', @CustomerId, @SalerId, 'Active');


----------------------------------------February Sales-----------------------------------------
INSERT INTO [External].Sale (SaleDate, CustomerId, AppUserId, SaleStatus) 
VALUES ('20210201 14:00', @CustomerId, @SalerId, 'Active')
, ('20210224 14:00', @CustomerId, @SalerId, 'Active');
...
, ('20210112 14:00', @CustomerId, @SalerId, 'Active');


----------------------------------------February Sales-----------------------------------------
INSERT INTO [External].Sale (SaleDate, CustomerId, AppUserId, SaleStatus) 
VALUES ('20210211 14:00', @CustomerId, @SalerId, 'Active')
, ('20210212 14:00', @CustomerId, @SalerId, 'Active');


----------------------------------------April Sales-------------------------------------------
INSERT INTO [External].Sale (SaleDate, CustomerId, AppUserId, SaleStatus) 
VALUES ('20210311 14:00', @CustomerId, @SalerId, 'Active')
, ('20210312 14:00', @CustomerId, @SalerId, 'Active');


------------------------------------------May Sales-------------------------------------------
INSERT INTO [External].Sale (SaleDate, CustomerId, AppUserId, SaleStatus) 
VALUES ('20210411 14:00', @CustomerId, @SalerId, 'Active')
, ('20210412 14:00', @CustomerId, @SalerId, 'Active');
...
, ('20210112 16:00', @CustomerId, @SalerId, 'Active');
